...
Original file is located at
    https://colab.research.google.com/drive/1rdPOHIaHWIwIjxpDkEzPbhYAIvydgWqK
...
### START CODE HERE ##
BestOfTv = ["Breakin Bed" , "Games of Thrones", "Mr Robot"]                                 ##Create list
print(BestOfTv)
BestOfTv.remove("Games of Thrones")                                  ##Remove Game Of Thrones
print(BestOfTv)
BestOfTv.insert( 0 , "Friends")                                       #Add Friends at index 0 

print(BestOfTv)
if "Games of Thrones" in BestOfTv:         ##Check if Game Of Thrones is in the list  
  print("GOT is in BestOfTv")
elif "Games of Thrones" not in BestOfTv:
...
print(len(food))                                    ##Display the length
print(food[2])                                    ##Display the item
